...
const _: () = {
    assert!(::std::mem::size_of::<rte_atomic16_t>() == 2usize, "Size of rte_atomic16_t");
    assert!(
        ::std::mem::align_of::<rte_atomic16_t>() == 2usize,
...
const _: () = {
    assert!(::std::mem::size_of::<rte_mbuf>() == 128usize, "Size of rte_mbuf");
    assert!(::std::mem::align_of::<rte_mbuf>() == 64usize, "Alignment of rte_mbuf");
    assert!(
