...
pub struct RenameMe {
    pub plain: ::std::os::raw::c_int,
    pub rust_friendly: ::std::os::raw::c_int,
    pub char_a: ::std::os::raw::c_char,
    pub _bitfield_1: __BindgenBitfieldUnit<[u8; 1usize]>,
    pub __bindgen_padding_0: u16,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of RenameMe"][::std::mem::size_of::<RenameMe>() - 12usize];
    ["Alignment of RenameMe"][::std::mem::align_of::<RenameMe>() - 4usize];
    [
        "Offset of field: RenameMe::plain",
    ][::std::mem::offset_of!(RenameMe, plain) - 0usize];
    [
        "Offset of field: RenameMe::rust_friendly",
    ][::std::mem::offset_of!(RenameMe, rust_friendly) - 4usize];
    [
        "Offset of field: RenameMe::char_a",
    ][::std::mem::offset_of!(RenameMe, char_a) - 8usize];
};
impl RenameMe {
    #[inline]
