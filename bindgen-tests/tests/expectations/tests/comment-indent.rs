...
pub mod root {
 ...
 This class is not so interesting, but worth a bit of docs too!*/
    ...
    const _: () = {
        assert!(::std::mem::size_of::<Foo_Bar>() == 1usize, "Size of Foo_Bar");
        assert!(::std::mem::align_of::<Foo_Bar>() == 1usize, "Alignment of Foo_Bar");
    };
    const _: () = {
 ...
 comment shouldn't be misaligned.*/
        ...
        const _: () = {
            assert!(::std::mem::size_of::<InInlineNS>() == 1usize, "Size of InInlineNS");
            assert!(
                ::std::mem::align_of::<InInlineNS>() == 1usize,
                "Alignment of InInlineNS",
            );
        };
        #[repr(C)]
        #[derive(Debug, Default, Copy, Clone)]
        ...
        const _: () = {
            assert!(::std::mem::size_of::<Bazz>() == 1usize, "Size of Bazz");
            assert!(::std::mem::align_of::<Bazz>() == 1usize, "Alignment of Bazz");
        };
    }
}
