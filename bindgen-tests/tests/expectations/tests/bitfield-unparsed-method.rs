...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
pub struct StructWithBitfieldAndMethod {
...
const _: () = {
    [
        "Size of StructWithBitfieldAndMethod",
    ][::std::mem::size_of::<StructWithBitfieldAndMethod>() - 4usize];
    [
        "Alignment of StructWithBitfieldAndMethod",
    ][::std::mem::align_of::<StructWithBitfieldAndMethod>() - 4usize];
};
unsafe extern "C" {
    #[link_name = "\u{1}_ZN27StructWithBitfieldAndMethod14regular_methodEv"]
    pub fn StructWithBitfieldAndMethod_regular_method(
        this: *mut StructWithBitfieldAndMethod,
    );
}
impl StructWithBitfieldAndMethod {
    #[inline]
    pub fn field(&self) -> ::std::os::raw::c_int {
        self._bitfield_1.get_const::<0usize, 1u8>() as u32 as _
    }
    #[inline]
    pub fn set_field(&mut self, val: ::std::os::raw::c_int) {
        let val: u32 = val as _;
        self._bitfield_1.set_const::<0usize, 1u8>(val as u64)
    }
    #[inline]
    pub unsafe fn field_raw(this: *const Self) -> ::std::os::raw::c_int {
        unsafe {
    ...
    #[inline]
    pub unsafe fn set_field_raw(this: *mut Self, val: ::std::os::raw::c_int) {
        unsafe {
            let val: u32 = val as _;
            <__BindgenBitfieldUnit<
                [u8; 1usize],
    ...
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit
            .set_const::<
                ...
                1u8,
            >({
                let field: u32 = field as _;
                field as u64
            });
        __bindgen_bitfield_unit
    }
    #[inline]
    pub unsafe fn regular_method(&mut self) {
        StructWithBitfieldAndMethod_regular_method(self)
    }
}
