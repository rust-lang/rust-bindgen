...
pub const JSVAL_LOWER_INCL_TAG_OF_OBJ_OR_NULL_SET: JSValueTag = JSValueTag::JSVAL_TAG_NULL;
pub const JSVAL_UPPER_EXCL_TAG_OF_PRIMITIVE_SET: JSValueTag = JSValueTag::JSVAL_TAG_OBJECT;
pub const JSVAL_UPPER_INCL_TAG_OF_NUMBER_SET: JSValueTag = JSValueTag::JSVAL_TAG_INT32;
pub const JSVAL_LOWER_INCL_TAG_OF_GCTHING_SET: JSValueTag = JSValueTag::JSVAL_TAG_STRING;
pub const JSVAL_LOWER_INCL_SHIFTED_TAG_OF_OBJ_OR_NULL_SET: JSValueShiftedTag = JSValueShiftedTag::JSVAL_SHIFTED_TAG_NULL;
pub const JSVAL_UPPER_EXCL_SHIFTED_TAG_OF_PRIMITIVE_SET: JSValueShiftedTag = JSValueShiftedTag::JSVAL_SHIFTED_TAG_OBJECT;
pub const JSVAL_UPPER_EXCL_SHIFTED_TAG_OF_NUMBER_SET: JSValueShiftedTag = JSValueShiftedTag::JSVAL_SHIFTED_TAG_UNDEFINED;
pub const JSVAL_LOWER_INCL_SHIFTED_TAG_OF_GCTHING_SET: JSValueShiftedTag = JSValueShiftedTag::JSVAL_SHIFTED_TAG_STRING;
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum JSWhyMagic {
