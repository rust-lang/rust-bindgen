    ...
    Storage: AsRef<[u8]> + AsMut<[u8]>,
{
    ...
    pub fn get(&self, bit_offset: usize, bit_width: u8) -> u64 {
        ...
        if cfg!(target_endian = "big") {
            for i in 0..bytes_needed {
                val |= (storage[start_byte + i].reverse_bits() as u128) << (i * 8);
            }
        } else {
            for i in 0..bytes_needed {
                val |= (storage[start_byte + i] as u128) << (i * 8);
            }
        }
        val >>= bit_shift;
        if bit_width < 64 {
            val &= (1u128 << bit_width) - 1;
        }
        if cfg!(target_endian = "big") {
            val = val.reverse_bits() >> (128 - bit_width as usize);
        }
        val as u64
    }
    #[inline]
    pub unsafe fn raw_get(this: *const Self, bit_offset: usize, bit_width: u8) -> u64 {
        ...
        if cfg!(target_endian = "big") {
            for i in 0..bytes_needed {
                ...
                val |= (byte.reverse_bits() as u128) << (i * 8);
            }
        } else {
            for i in 0..bytes_needed {
                let byte = unsafe { *storage_ptr.add(start_byte + i) };
    ...
    pub fn set(&mut self, bit_offset: usize, bit_width: u8, val: u64) {
        ...
        let bytes_needed = (bit_width as usize + bit_shift + 7) / 8;
        val <<= bit_shift;
        let field_mask = ((1u128 << bit_width) - 1) << bit_shift;
        for i in 0..bytes_needed {
    ...
    pub const fn get_const<const BIT_OFFSET: usize, const BIT_WIDTH: u8>(&self) -> u64 {
        ...
        if BIT_WIDTH as usize + bit_shift <= usize::BITS as usize {
            ...
            if cfg!(target_endian = "big") {
                ...
                while i < bytes_needed {
                    val
                        |= (self.storage[start_byte + i].reverse_bits() as u128)
                            << (i * 8);
                    i += 1;
                }
            } else {
                let mut i = 0;
                while i < bytes_needed {
                    val |= (self.storage[start_byte + i] as u128) << (i * 8);
                    i += 1;
                }
            }
            val >>= bit_shift;
...
fn bindgen_test_layout_S() {
    assert_eq!(::std::mem::size_of::<S>(), 9usize, "Size of S");
    assert_eq!(::std::mem::align_of::<S>(), 1usize, "Alignment of S");
}
impl S {
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub fn p(&self) -> ::std::os::raw::c_ulonglong {
        unsafe {
            ::std::mem::transmute(self._bitfield_1.get_const::<0usize, 2u8>() as u64)
        }
    }
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub fn set_p(&mut self, val: ::std::os::raw::c_ulonglong) {
        unsafe {
    ...
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub unsafe fn p_raw(this: *const Self) -> ::std::os::raw::c_ulonglong {
        unsafe {
            ::std::mem::transmute(
    ...
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub unsafe fn set_p_raw(this: *mut Self, val: ::std::os::raw::c_ulonglong) {
        unsafe {
            let val: u64 = ::std::mem::transmute(val);
            <__BindgenBitfieldUnit<
                [u8; 9usize],
    ...
    pub fn x(&self) -> ::std::os::raw::c_ulonglong {
        unsafe {
            ::std::mem::transmute(self._bitfield_1.get_const::<2usize, 63u8>() as u64)
        }
    }
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub fn set_x(&mut self, val: ::std::os::raw::c_ulonglong) {
        unsafe {
            let val: u64 = ::std::mem::transmute(val);
            self._bitfield_1.set_const::<2usize, 63u8>(val as u64)
        }
    }
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub unsafe fn x_raw(this: *const Self) -> ::std::os::raw::c_ulonglong {
        unsafe {
            ::std::mem::transmute(
                <__BindgenBitfieldUnit<
                    [u8; 9usize],
    ...
    #[inline]
    #[allow(unnecessary_transmutes)]
    pub unsafe fn set_x_raw(this: *mut Self, val: ::std::os::raw::c_ulonglong) {
        unsafe {
            let val: u64 = ::std::mem::transmute(val);
            <__BindgenBitfieldUnit<
                [u8; 9usize],
    ...
    pub fn new_bitfield_1(
        p: ::std::os::raw::c_ulonglong,
        x: ::std::os::raw::c_ulonglong,
        ...
        __bindgen_bitfield_unit
            .set_const::<
                ...
                2u8,
            >({
                let p: u64 = unsafe { ::std::mem::transmute(p) };
                p as u64
            });
        __bindgen_bitfield_unit
            .set_const::<
