...
const _: () = {
    ...
    assert!(::std::mem::offset_of!(A, x) == 0usize, "Offset of field: A::x");
    assert!(::std::mem::offset_of!(A, y) == 3usize, "Offset of field: A::y");
};
impl A {
    #[inline]
...
const _: () = {
    ...
    assert!(::std::mem::offset_of!(C, x) == 0usize, "Offset of field: C::x");
    assert!(::std::mem::offset_of!(C, baz) == 4usize, "Offset of field: C::baz");
};
impl C {
    #[inline]
    pub fn b1(&self) -> ::std::os::raw::c_uint {
...
const _: () = {
    assert!(::std::mem::size_of::<Date1>() == 4usize, "Size of Date1");
    assert!(::std::mem::align_of::<Date1>() == 2usize, "Alignment of Date1");
};
impl Date1 {
    #[inline]
...
const _: () = {
    assert!(::std::mem::size_of::<Date2>() == 4usize, "Size of Date2");
    assert!(::std::mem::align_of::<Date2>() == 2usize, "Alignment of Date2");
};
impl Date2 {
    #[inline]
    pub fn nWeekDay(&self) -> ::std::os::raw::c_ushort {
...
const _: () = {
    assert!(::std::mem::size_of::<Date3>() == 4usize, "Size of Date3");
    assert!(::std::mem::align_of::<Date3>() == 2usize, "Alignment of Date3");
    assert!(
        ::std::mem::offset_of!(Date3, byte) == 3usize,
        "Offset of field: Date3::byte",
    );
};
impl Date3 {
    #[inline]
