...
const _: () = {
    assert!(::std::mem::size_of::<my_struct1>() == 4usize, "Size of my_struct1");
    assert!(::std::mem::align_of::<my_struct1>() == 4usize, "Alignment of my_struct1");
};
impl my_struct1 {
    #[inline]
...
const _: () = {
    assert!(::std::mem::size_of::<my_struct2>() == 4usize, "Size of my_struct2");
    assert!(::std::mem::align_of::<my_struct2>() == 4usize, "Alignment of my_struct2");
};
impl my_struct2 {
    #[inline]
