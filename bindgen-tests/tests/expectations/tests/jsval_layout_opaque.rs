...
const _: () = {
    assert!(::std::mem::size_of::<jsval_layout>() == 8usize, "Size of jsval_layout");
    assert!(
        ::std::mem::align_of::<jsval_layout>() == 8usize,
...
const _: () = {
    assert!(::std::mem::size_of::<Value>() == 8usize, "Size of Value");
    assert!(::std::mem::align_of::<Value>() == 8usize, "Alignment of Value");
    assert!(
        ::std::mem::offset_of!(Value, data) == 0usize,
