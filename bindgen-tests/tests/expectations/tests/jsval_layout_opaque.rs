...
pub const JSVAL_PAYLOAD_MASK: u64 = 0x7fffffffffff;
pub const JSVAL_TAG_MASK: i64 = -0x800000000000;
#[repr(u8)]
...
pub enum JSValueType {
    ...
    JSVAL_TYPE_BOOLEAN = 0x3,
    JSVAL_TYPE_MAGIC = 0x4,
    JSVAL_TYPE_STRING = 0x5,
    JSVAL_TYPE_SYMBOL = 0x6,
    JSVAL_TYPE_NULL = 0x7,
    JSVAL_TYPE_OBJECT = 0x8,
...
pub enum JSValueShiftedTag {
    JSVAL_SHIFTED_TAG_MAX_DOUBLE = 0xfff80000ffffffff,
