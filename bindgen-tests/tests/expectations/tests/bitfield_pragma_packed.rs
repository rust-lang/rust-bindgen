...
const _: () = {
    assert!(::std::mem::size_of::<Struct>() == 4usize, "Size of Struct");
    assert!(::std::mem::align_of::<Struct>() == 1usize, "Alignment of Struct");
};
impl Struct {
    #[inline]
...
const _: () = {
    assert!(::std::mem::size_of::<Inner>() == 4usize, "Size of Inner");
...
const _: () = {
    assert!(::std::mem::size_of::<Outer>() == 4usize, "Size of Outer");
    assert!(::std::mem::align_of::<Outer>() == 1usize, "Alignment of Outer");
    assert!(
        ::std::mem::offset_of!(Outer, inner) == 0usize,
        "Offset of field: Outer::inner",
    );
};
