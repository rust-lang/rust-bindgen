...
const _: () = {
    assert!(
        ::std::mem::size_of::<cmdline_token_hdr>() == 16usize,
        "Size of cmdline_token_hdr",
    );
    assert!(
...
const _: () = {
    assert!(
        ::std::mem::size_of::<cmdline_token_ops>() == 32usize,
        "Size of cmdline_token_ops",
    );
    assert!(
...
const _: () = {
    assert!(
        ::std::mem::size_of::<cmdline_token_num>() == 24usize,
        "Size of cmdline_token_num",
    );
    assert!(
