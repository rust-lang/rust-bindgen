...
const _: () = {
    assert!(
        ::std::mem::size_of::<rte_ipv4_tuple>() == 12usize,
        "Size of rte_ipv4_tuple",
    );
    assert!(
        ::std::mem::align_of::<rte_ipv4_tuple>() == 4usize,
...
const _: () = {
    assert!(
        ::std::mem::size_of::<rte_ipv6_tuple>() == 36usize,
        "Size of rte_ipv6_tuple",
    );
    assert!(
        ::std::mem::align_of::<rte_ipv6_tuple>() == 4usize,
...
const _: () = {
    assert!(
        ::std::mem::size_of::<rte_thash_tuple>() == 48usize,
