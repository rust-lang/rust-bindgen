...
const _: () = {
    assert!(::std::mem::size_of::<timex>() == 48usize, "Size of timex");
    assert!(::std::mem::align_of::<timex>() == 4usize, "Alignment of timex");
    assert!(::std::mem::offset_of!(timex, tai) == 0usize, "Offset of field: timex::tai");
};
...
const _: () = {
    assert!(::std::mem::size_of::<timex_named>() == 48usize, "Size of timex_named");
    assert!(::std::mem::align_of::<timex_named>() == 4usize, "Alignment of timex_named");
    assert!(
