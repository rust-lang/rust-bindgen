...
const _: () = {
    assert!(::std::mem::size_of::<bitfield>() == 16usize, "Size of bitfield");
    assert!(::std::mem::align_of::<bitfield>() == 4usize, "Alignment of bitfield");
    assert!(
        ::std::mem::offset_of!(bitfield, e) == 4usize,
        "Offset of field: bitfield::e",
    );
};
impl bitfield {
    #[inline]
