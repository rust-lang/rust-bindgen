...
const _: () = {
    assert!(::std::mem::size_of::<Test__Float16>() == 2usize, "Size of Test__Float16");
    assert!(
        ::std::mem::align_of::<Test__Float16>() == 2usize,
        "Alignment of Test__Float16",
    );
    assert!(
...
const _: () = {
    assert!(
        ::std::mem::size_of::<Test__Float16Ref>() == 8usize,
        "Size of Test__Float16Ref",
    );
    assert!(
