...
const _: () = {
    assert!(::std::mem::size_of::<NonCopyType>() == 4usize, "Size of NonCopyType");
    assert!(::std::mem::align_of::<NonCopyType>() == 4usize, "Alignment of NonCopyType");
    assert!(
...
const _: () = {
    assert!(
        ::std::mem::size_of::<WithManuallyDrop>() == 4usize,
        "Size of WithManuallyDrop",
    );
    assert!(
...
const _: () = {
    assert!(
        ::std::mem::size_of::<WithDefaultWrapper>() == 4usize,
        "Size of WithDefaultWrapper",
    );
    assert!(
