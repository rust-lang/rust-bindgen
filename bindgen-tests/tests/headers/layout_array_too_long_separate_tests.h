// bindgen-flags: --with-derive-hash --with-derive-partialeq --with-derive-eq --impl-partialeq --rustified-enum ".*" --separate-layout-tests-path generated/layout_array_too_long_layout_tests.rs
