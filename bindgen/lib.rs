...
=======
    ...
    pub fn command_line_flags(&self) -> Vec<String> {
        ...
        #[cfg(feature = "experimental")]
        if *emit_diagnostics {
            output_vector.push("--emit-diagnostics".into());
        }
...
>>>>>>> 57f66e9c (Put all the diagnostic logic under the experimental flag)
...
impl Default for BindgenOptions {
    fn default() -> BindgenOptions {
        macro_rules! options {
            ($($(#[$field_attrs:meta])* $field:ident $(: $value:expr)?,)* --default-fields-- $($(#[$default_attrs:meta])* $default_field:ident,)*) => {
                BindgenOptions {
