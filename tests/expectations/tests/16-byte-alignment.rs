...
pub mod root {
    ...
    fn bindgen_test_layout_rte_ipv4_tuple__bindgen_ty_1() {
        ...
        assert_eq! (unsafe {
                    ...
                    "Alignment of field: " , stringify ! (
                    rte_ipv4_tuple__bindgen_ty_1 ) , "::" , stringify ! (
                    sctp_tag ) ));
    }
    ...
    fn bindgen_test_layout_rte_ipv4_tuple() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_ipv4_tuple ) ) . src_addr as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_ipv4_tuple ) ,
                    "::" , stringify ! ( src_addr ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_ipv4_tuple ) ) . dst_addr as *
    ...
    fn bindgen_test_layout_rte_ipv6_tuple__bindgen_ty_1() {
        ...
        assert_eq! (unsafe {
                    ...
                    sctp_tag as * const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_ipv6_tuple__bindgen_ty_1 ) , "::" , stringify ! (
                    sctp_tag ) ));
    }
    ...
    fn bindgen_test_layout_rte_ipv6_tuple() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_ipv6_tuple ) ) . src_addr as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_ipv6_tuple ) ,
                    "::" , stringify ! ( src_addr ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_ipv6_tuple ) ) . dst_addr as *
    ...
    fn bindgen_test_layout_rte_thash_tuple() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_thash_tuple ) ) . v4 as * const _
                    as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_thash_tuple ) ,
                    "::" , stringify ! ( v4 ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_thash_tuple ) ) . v6 as * const _
                    as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_thash_tuple ) ,
                    "::" , stringify ! ( v6 ) ));
    }
