...
pub mod root {
    ...
    fn bindgen_test_layout_SomeAccessors() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const SomeAccessors ) ) . mUnsafeAccessors
                    as * const _ as usize } , 8usize , concat ! (
                    "Alignment of field: " , stringify ! ( SomeAccessors ) ,
                    "::" , stringify ! ( mUnsafeAccessors ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const SomeAccessors ) ) .
    ...
    impl SomeAccessors {
        ...
        #[inline]
        pub fn get_mBothAccessors_mut(&mut self)
    ...
    fn bindgen_test_layout_AllAccessors() {
        ...
        assert_eq! (unsafe {
                    ...
                    * const _ as usize } , 0usize , concat ! (
                    ...
                    "::" , stringify ! ( mBothAccessors ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const AllAccessors ) ) . mAlsoBothAccessors
    ...
    fn bindgen_test_layout_AllUnsafeAccessors() {
        ...
        assert_eq! (unsafe {
                    ...
                    mBothAccessors as * const _ as usize } , 0usize , concat !
                    (
    ...
    impl AllUnsafeAccessors {
        ...
        #[inline]
        pub unsafe fn get_mAlsoBothAccessors(&self)
         -> &::std::os::raw::c_int {
            &self.mAlsoBothAccessors
        }
        #[inline]
    ...
    fn bindgen_test_layout_ContradictAccessors() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ContradictAccessors ) ) .
                    mNoAccessors as * const _ as usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! ( ContradictAccessors
    ...
    fn bindgen_test_layout_Replaced() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const Replaced ) ) . mAccessor as * const _
    ...
    fn bindgen_test_layout_Wrapper() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const Wrapper ) ) . mReplaced as * const _
                    as usize } , 0usize , concat ! (
