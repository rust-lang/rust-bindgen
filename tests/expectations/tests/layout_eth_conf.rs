 ...
 */
    ...
    fn bindgen_test_layout_rte_eth_rxmode() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_rxmode ) ) . mq_mode as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_rxmode ) ,
                    "::" , stringify ! ( mq_mode ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_rxmode ) ) . max_rx_pkt_len
                    as * const _ as usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_rxmode ) ,
                    "::" , stringify ! ( max_rx_pkt_len ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_rxmode ) ) . split_hdr_size
 ...
 */
    ...
    fn bindgen_test_layout_rte_eth_txmode() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_txmode ) ) . mq_mode as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_txmode ) ,
                    "::" , stringify ! ( mq_mode ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_txmode ) ) . pvid as * const
 ...
 */
    ...
    fn bindgen_test_layout_rte_eth_rss_conf() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_rss_conf ) ) . rss_key as *
                    const _ as usize } , 0usize , concat ! (
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_rss_conf ) ) . rss_hf as *
 ...
 */
    ...
    fn bindgen_test_layout_rte_eth_vmdq_dcb_conf() {
        assert_eq!(::std::mem::size_of::<rte_eth_vmdq_dcb_conf>() , 1040usize
                   , concat ! (
                   "Size of: " , stringify ! ( rte_eth_vmdq_dcb_conf ) ));
        ...
        assert_eq! (unsafe {
                    ...
                    (
                    "Alignment of field: " , stringify ! (
                    rte_eth_vmdq_dcb_conf ) , "::" , stringify ! (
                    nb_queue_pools ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_vmdq_dcb_conf ) ) .
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_vmdq_dcb_conf ) ) .
                    nb_pool_maps as * const _ as usize } , 6usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_vmdq_dcb_conf ) , "::" , stringify ! (
                    nb_pool_maps ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_vmdq_dcb_conf ) ) . pool_map
                    as * const _ as usize } , 8usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_vmdq_dcb_conf ) , "::" , stringify ! ( pool_map )
                    ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_vmdq_dcb_conf ) ) . dcb_tc as
                    * const _ as usize } , 1032usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_vmdq_dcb_conf ) , "::" , stringify ! ( dcb_tc )
                    ));
    }
    ...
    fn bindgen_test_layout_rte_eth_vmdq_dcb_tx_conf() {
        ...
        assert_eq! (::std::mem::align_of::<rte_eth_vmdq_dcb_tx_conf>() ,
                    4usize , concat ! (
        ...
        assert_eq! (unsafe {
                    ...
                    nb_queue_pools ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_vmdq_dcb_tx_conf ) ) . dcb_tc
                    as * const _ as usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! (
    ...
    fn bindgen_test_layout_rte_eth_vmdq_tx_conf() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_vmdq_tx_conf ) ) .
                    nb_queue_pools as * const _ as usize } , 0usize , concat !
                    (
                    "Alignment of field: " , stringify ! (
                    rte_eth_vmdq_tx_conf ) , "::" , stringify ! (
                    nb_queue_pools ) ));
    }
    ...
    fn bindgen_test_layout_rte_eth_vmdq_rx_conf() {
        assert_eq!(::std::mem::size_of::<rte_eth_vmdq_rx_conf>() , 1040usize ,
                   concat ! (
                   "Size of: " , stringify ! ( rte_eth_vmdq_rx_conf ) ));
        ...
        assert_eq! (unsafe {
                    ...
                    (
                    "Alignment of field: " , stringify ! (
                    rte_eth_vmdq_rx_conf ) , "::" , stringify ! (
                    nb_queue_pools ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_vmdq_rx_conf ) ) .
                    enable_default_pool as * const _ as usize } , 4usize ,
        ...
        assert_eq! (unsafe {
                    ...
                    default_pool as * const _ as usize } , 5usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_vmdq_rx_conf ) , "::" , stringify ! ( default_pool
                    ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_vmdq_rx_conf ) ) .
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_vmdq_rx_conf ) ) .
                    nb_pool_maps as * const _ as usize } , 7usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_vmdq_rx_conf ) , "::" , stringify ! ( nb_pool_maps
                    ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_vmdq_rx_conf ) ) . rx_mode as
                    * const _ as usize } , 8usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_vmdq_rx_conf ) , "::" , stringify ! ( rx_mode )
                    ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_vmdq_rx_conf ) ) . pool_map
                    as * const _ as usize } , 16usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_vmdq_rx_conf ) , "::" , stringify ! ( pool_map )
                    ));
    }
 ...
 */
    ...
    fn bindgen_test_layout_rte_eth_ipv4_flow() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_ipv4_flow ) ) . src_ip as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_ipv4_flow )
                    , "::" , stringify ! ( src_ip ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_ipv4_flow ) ) . dst_ip as *
                    const _ as usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_ipv4_flow )
                    , "::" , stringify ! ( dst_ip ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_ipv4_flow ) ) . tos as *
                    const _ as usize } , 8usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_ipv4_flow )
                    , "::" , stringify ! ( tos ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_ipv4_flow ) ) . ttl as *
                    const _ as usize } , 9usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_ipv4_flow )
                    , "::" , stringify ! ( ttl ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_ipv4_flow ) ) . proto as *
 ...
 */
    ...
    fn bindgen_test_layout_rte_eth_ipv6_flow() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_ipv6_flow ) ) . src_ip as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_ipv6_flow )
                    , "::" , stringify ! ( src_ip ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_ipv6_flow ) ) . dst_ip as *
                    const _ as usize } , 16usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_ipv6_flow )
                    , "::" , stringify ! ( dst_ip ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_ipv6_flow ) ) . tc as * const
                    _ as usize } , 32usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_ipv6_flow )
                    , "::" , stringify ! ( tc ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_ipv6_flow ) ) . proto as *
 ...
 */
    ...
    fn bindgen_test_layout_rte_eth_fdir_masks() {
        ...
        assert_eq! (unsafe {
                    ...
                    vlan_tci_mask as * const _ as usize } , 0usize , concat !
                    (
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_fdir_masks ) ) .
                    src_port_mask as * const _ as usize } , 52usize , concat !
                    (
                    "Alignment of field: " , stringify ! ( rte_eth_fdir_masks
                    ) , "::" , stringify ! ( src_port_mask ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_fdir_masks ) ) .
                    dst_port_mask as * const _ as usize } , 54usize , concat !
                    (
                    "Alignment of field: " , stringify ! ( rte_eth_fdir_masks
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_fdir_masks ) ) .
                    tunnel_id_mask as * const _ as usize } , 60usize , concat
                    ! (
                    "Alignment of field: " , stringify ! ( rte_eth_fdir_masks
                    ) , "::" , stringify ! ( tunnel_id_mask ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_fdir_masks ) ) .
                    tunnel_type_mask as * const _ as usize } , 64usize ,
                    concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_fdir_masks
 ...
 */
    ...
    fn bindgen_test_layout_rte_eth_flex_payload_cfg() {
        ...
        assert_eq! (::std::mem::align_of::<rte_eth_flex_payload_cfg>() ,
                    4usize , concat ! (
                    "Alignment of " , stringify ! ( rte_eth_flex_payload_cfg )
                    ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_flex_payload_cfg ) ) . type_
                    as * const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_flex_payload_cfg ) , "::" , stringify ! ( type_ )
                    ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_flex_payload_cfg ) ) .
                    src_offset as * const _ as usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_flex_payload_cfg ) , "::" , stringify ! (
                    src_offset ) ));
    }
    ...
    fn bindgen_test_layout_rte_eth_fdir_flex_mask() {
        ...
        assert_eq! (unsafe {
                    ...
                    * const _ as usize } , 2usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_fdir_flex_mask ) , "::" , stringify ! ( mask ) ));
    }
 ...
 */
    ...
    fn bindgen_test_layout_rte_eth_fdir_flex_conf() {
        assert_eq!(::std::mem::size_of::<rte_eth_fdir_flex_conf>() , 688usize
                   , concat ! (
                   "Size of: " , stringify ! ( rte_eth_fdir_flex_conf ) ));
        assert_eq! (::std::mem::align_of::<rte_eth_fdir_flex_conf>() , 4usize
                    , concat ! (
                    "Alignment of " , stringify ! ( rte_eth_fdir_flex_conf )
                    ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_fdir_flex_conf ) ) .
                    nb_payloads as * const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_fdir_flex_conf ) , "::" , stringify ! (
                    nb_payloads ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_fdir_flex_conf ) ) .
                    nb_flexmasks as * const _ as usize } , 2usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_fdir_flex_conf ) , "::" , stringify ! (
                    nb_flexmasks ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_fdir_flex_conf ) ) . flex_set
                    as * const _ as usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_fdir_flex_conf ) , "::" , stringify ! ( flex_set )
                    ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_fdir_flex_conf ) ) .
                    flex_mask as * const _ as usize } , 292usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_eth_fdir_flex_conf ) , "::" , stringify ! ( flex_mask
                    ) ));
    }
 ...
 */
    ...
    fn bindgen_test_layout_rte_fdir_conf() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_fdir_conf ) ) . mode as * const _
                    as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_fdir_conf ) ,
                    "::" , stringify ! ( mode ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_fdir_conf ) ) . pballoc as *
                    const _ as usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_fdir_conf ) ,
                    "::" , stringify ! ( pballoc ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_fdir_conf ) ) . status as * const
                    _ as usize } , 8usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_fdir_conf ) ,
                    "::" , stringify ! ( status ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_fdir_conf ) ) . drop_queue as *
                    const _ as usize } , 12usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_fdir_conf ) ,
                    "::" , stringify ! ( drop_queue ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_fdir_conf ) ) . mask as * const _
                    as usize } , 16usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_fdir_conf ) ,
                    "::" , stringify ! ( mask ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_fdir_conf ) ) . flex_conf as *
 ...
 */
    ...
    fn bindgen_test_layout_rte_intr_conf() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_intr_conf ) ) . lsc as * const _
                    as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_intr_conf ) ,
                    "::" , stringify ! ( lsc ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_intr_conf ) ) . rxq as * const _
 ...
 */
    ...
    fn bindgen_test_layout_rte_eth_conf__bindgen_ty_1() {
        ...
        assert_eq! (unsafe {
                    ...
                    rss_conf as * const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! (
    ...
    fn bindgen_test_layout_rte_eth_conf__bindgen_ty_2() {
        assert_eq!(::std::mem::size_of::<rte_eth_conf__bindgen_ty_2>() ,
                   12usize , concat ! (
    ...
    fn bindgen_test_layout_rte_eth_conf() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_conf ) ) . link_speeds as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_conf ) ,
                    "::" , stringify ! ( link_speeds ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_conf ) ) . rxmode as * const
                    _ as usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_conf ) ,
                    "::" , stringify ! ( rxmode ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_conf ) ) . txmode as * const
                    _ as usize } , 16usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_conf ) ,
                    "::" , stringify ! ( txmode ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_conf ) ) . lpbk_mode as *
                    const _ as usize } , 24usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_conf ) ,
                    "::" , stringify ! ( lpbk_mode ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_conf ) ) . rx_adv_conf as *
                    const _ as usize } , 32usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_conf ) ,
                    "::" , stringify ! ( rx_adv_conf ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_conf ) ) . tx_adv_conf as *
                    const _ as usize } , 2152usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_conf ) ,
                    "::" , stringify ! ( tx_adv_conf ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_conf ) ) . dcb_capability_en
                    as * const _ as usize } , 2164usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_conf ) ,
                    "::" , stringify ! ( dcb_capability_en ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_conf ) ) . fdir_conf as *
                    const _ as usize } , 2168usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_conf ) ,
                    "::" , stringify ! ( fdir_conf ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_eth_conf ) ) . intr_conf as *
                    const _ as usize } , 2940usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_eth_conf ) ,
                    "::" , stringify ! ( intr_conf ) ));
    }
