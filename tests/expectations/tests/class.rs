...
pub mod root {
    ...
    fn bindgen_test_layout_C() {
        ...
        assert_eq! (unsafe {
                    ...
                    stringify ! ( a ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const C ) ) . big_array as * const _ as
                    usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! ( C ) , "::" ,
                    stringify ! ( big_array ) ));
    }
    ...
    fn bindgen_test_layout_C_with_zero_length_array() {
        ...
        assert_eq! (::std::mem::align_of::<C_with_zero_length_array>() ,
                    4usize , concat ! (
        ...
        assert_eq! (unsafe {
                    ...
                    big_array as * const _ as usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! (
    ...
    fn bindgen_test_layout_WithDtor() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const WithDtor ) ) . b as * const _ as
                    usize } , 0usize , concat ! (
    ...
    fn bindgen_test_layout_IncompleteArrayNonCopiable() {
        assert_eq!(::std::mem::size_of::<IncompleteArrayNonCopiable>() ,
                   8usize , concat ! (
