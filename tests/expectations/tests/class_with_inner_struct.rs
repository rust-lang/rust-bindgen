...
pub mod root {
    ...
    fn bindgen_test_layout_A_Segment() {
        ...
        assert_eq! (unsafe {
                    ...
                    , stringify ! ( begin ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const A_Segment ) ) . end as * const _ as
                    usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! ( A_Segment ) , "::"
                    , stringify ! ( end ) ));
    }
    ...
    fn bindgen_test_layout_A__bindgen_ty_1() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const A__bindgen_ty_1 ) ) . f as * const _
    ...
    fn bindgen_test_layout_A__bindgen_ty_2() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const A__bindgen_ty_2 ) ) . d as * const _
                    as usize } , 0usize , concat ! (
    ...
    fn bindgen_test_layout_A() {
        ...
        assert_eq! (unsafe {
                    ...
                    stringify ! ( c ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const A ) ) . named_union as * const _ as
                    usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! ( A ) , "::" ,
    ...
    fn bindgen_test_layout_B_Segment() {
        ...
        assert_eq! (unsafe {
                    ...
                    , stringify ! ( begin ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const B_Segment ) ) . end as * const _ as
                    usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! ( B_Segment ) , "::"
                    , stringify ! ( end ) ));
    }
    ...
    fn bindgen_test_layout_C__bindgen_ty_1__bindgen_ty_1() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const C__bindgen_ty_1__bindgen_ty_1 ) ) .
    ...
    fn bindgen_test_layout_C__bindgen_ty_1() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const C__bindgen_ty_1 ) ) . mFunc as *
    ...
    fn bindgen_test_layout_C_Segment() {
        ...
        assert_eq! (unsafe {
                    ...
                    , stringify ! ( begin ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const C_Segment ) ) . end as * const _ as
                    usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! ( C_Segment ) , "::"
                    , stringify ! ( end ) ));
    }
