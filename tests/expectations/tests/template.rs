...
pub mod root {
    ...
    fn bindgen_test_layout_RootedContainer() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const RootedContainer ) ) . root as * const
    ...
    fn bindgen_test_layout_POD() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const POD ) ) . opaque_member as * const _
 ...
 */
    ...
    #[test]
    fn __bindgen_test_layout_Foo_instantiation_96() {
        assert_eq!(::std::mem::size_of::<Foo<::std::os::raw::c_int>>() ,
                   24usize , concat ! (
                   "Size of template specialization: " , stringify ! (
                   Foo<::std::os::raw::c_int> ) ));
        assert_eq!(::std::mem::align_of::<Foo<::std::os::raw::c_int>>() ,
                   8usize , concat ! (
    ...
    #[test]
    fn __bindgen_test_layout_WithDtor_instantiation_115() {
