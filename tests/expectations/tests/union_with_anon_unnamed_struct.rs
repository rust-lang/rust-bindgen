...
pub mod root {
    ...
    fn bindgen_test_layout_pixel__bindgen_ty_1() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const pixel__bindgen_ty_1 ) ) . r as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( pixel__bindgen_ty_1
                    ) , "::" , stringify ! ( r ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const pixel__bindgen_ty_1 ) ) . g as *
                    const _ as usize } , 1usize , concat ! (
                    "Alignment of field: " , stringify ! ( pixel__bindgen_ty_1
                    ) , "::" , stringify ! ( g ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const pixel__bindgen_ty_1 ) ) . b as *
                    const _ as usize } , 2usize , concat ! (
                    "Alignment of field: " , stringify ! ( pixel__bindgen_ty_1
                    ) , "::" , stringify ! ( b ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const pixel__bindgen_ty_1 ) ) . a as *
    ...
    fn bindgen_test_layout_pixel() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const pixel ) ) . rgba as * const _ as
                    usize } , 0usize , concat ! (
