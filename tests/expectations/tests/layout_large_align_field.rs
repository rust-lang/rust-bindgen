...
pub mod root {
    ...
    pub const IP_LAST_FRAG_IDX: _bindgen_ty_1 =
        _bindgen_ty_1::IP_LAST_FRAG_IDX;
    pub const IP_FIRST_FRAG_IDX: _bindgen_ty_1 =
        _bindgen_ty_1::IP_FIRST_FRAG_IDX;
    ...
    fn bindgen_test_layout_ip_frag() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag ) ) . ofs as * const _ as
                    usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( ip_frag ) , "::" ,
                    stringify ! ( ofs ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag ) ) . len as * const _ as
                    usize } , 2usize , concat ! (
                    "Alignment of field: " , stringify ! ( ip_frag ) , "::" ,
                    stringify ! ( len ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag ) ) . mb as * const _ as
                    usize } , 8usize , concat ! (
                    "Alignment of field: " , stringify ! ( ip_frag ) , "::" ,
                    stringify ! ( mb ) ));
    }
    ...
    fn bindgen_test_layout_ip_frag_key() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag_key ) ) . src_dst as * const
        ...
        assert_eq! (unsafe {
                    ...
                    "::" , stringify ! ( id ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag_key ) ) . key_len as * const
 ...
 */
    ...
    fn bindgen_test_layout_ip_frag_pkt__bindgen_ty_1() {
        assert_eq!(::std::mem::size_of::<ip_frag_pkt__bindgen_ty_1>() ,
                   16usize , concat ! (
                   "Size of: " , stringify ! ( ip_frag_pkt__bindgen_ty_1 ) ));
        assert_eq! (::std::mem::align_of::<ip_frag_pkt__bindgen_ty_1>() ,
                    8usize , concat ! (
                    "Alignment of " , stringify ! ( ip_frag_pkt__bindgen_ty_1
                    ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag_pkt__bindgen_ty_1 ) ) .
    ...
    fn bindgen_test_layout_ip_frag_pkt() {
        ...
        assert_eq! (unsafe {
                    ...
                    "::" , stringify ! ( key ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag_pkt ) ) . start as * const _
                    as usize } , 56usize , concat ! (
                    "Alignment of field: " , stringify ! ( ip_frag_pkt ) ,
                    "::" , stringify ! ( start ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag_pkt ) ) . total_size as *
                    const _ as usize } , 64usize , concat ! (
                    "Alignment of field: " , stringify ! ( ip_frag_pkt ) ,
                    "::" , stringify ! ( total_size ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag_pkt ) ) . frag_size as *
                    const _ as usize } , 68usize , concat ! (
                    "Alignment of field: " , stringify ! ( ip_frag_pkt ) ,
                    "::" , stringify ! ( frag_size ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag_pkt ) ) . last_idx as * const
                    _ as usize } , 72usize , concat ! (
                    "Alignment of field: " , stringify ! ( ip_frag_pkt ) ,
                    "::" , stringify ! ( last_idx ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag_pkt ) ) . frags as * const _
    ...
    fn bindgen_test_layout_ip_pkt_list() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_pkt_list ) ) . tqh_first as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( ip_pkt_list ) ,
                    "::" , stringify ! ( tqh_first ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_pkt_list ) ) . tqh_last as * const
    ...
    fn bindgen_test_layout_ip_frag_tbl_stat() {
        ...
        assert_eq! (unsafe {
                    ...
                    , "::" , stringify ! ( find_num ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag_tbl_stat ) ) . add_num as *
                    const _ as usize } , 8usize , concat ! (
                    "Alignment of field: " , stringify ! ( ip_frag_tbl_stat )
                    , "::" , stringify ! ( add_num ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag_tbl_stat ) ) . del_num as *
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const ip_frag_tbl_stat ) ) . fail_nospace
    ...
    fn bindgen_test_layout_rte_ip_frag_tbl() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_ip_frag_tbl ) ) . bucket_entries
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_ip_frag_tbl ) ) . last as * const
                    _ as usize } , 32usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_ip_frag_tbl ) ,
                    "::" , stringify ! ( last ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_ip_frag_tbl ) ) . lru as * const
                    _ as usize } , 40usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_ip_frag_tbl ) ,
                    "::" , stringify ! ( lru ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_ip_frag_tbl ) ) . stat as * const
                    _ as usize } , 64usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_ip_frag_tbl ) ,
                    "::" , stringify ! ( stat ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_ip_frag_tbl ) ) . pkt as * const
