...
pub mod root {
    ...
    fn bindgen_test_layout_nsFoo() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const nsFoo ) ) . mBar as * const _ as
                    usize } , 0usize , concat ! (
    ...
    fn bindgen_test_layout_mozilla_FragmentOrURL() {
        assert_eq!(::std::mem::size_of::<mozilla_FragmentOrURL>() , 1usize ,
                   concat ! (
                   "Size of: " , stringify ! ( mozilla_FragmentOrURL ) ));
        assert_eq! (::std::mem::align_of::<mozilla_FragmentOrURL>() , 1usize ,
                    concat ! (
                    "Alignment of " , stringify ! ( mozilla_FragmentOrURL )
                    ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const mozilla_FragmentOrURL ) ) .
                    mIsLocalRef as * const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    mozilla_FragmentOrURL ) , "::" , stringify ! ( mIsLocalRef
                    ) ));
    }
