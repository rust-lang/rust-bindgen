...
pub mod root {
    ...
    pub mod _bindgen_mod_id_13 {
        ...
        pub type typedef_struct = root::_bindgen_mod_id_13::_bindgen_ty_1;
        pub const _bindgen_mod_id_13_BAR:
                  root::_bindgen_mod_id_13::_bindgen_ty_2 =
            _bindgen_ty_2::BAR;
        #[repr(u32)]
        #[derive(Debug, Copy, Clone, PartialEq, Eq, Hash)]
        pub enum _bindgen_ty_2 { BAR = 1, }
        pub use self::super::super::root::_bindgen_mod_id_13::_bindgen_ty_2 as
                typedef_enum;
    }
}
