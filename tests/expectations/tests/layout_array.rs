 ...
 */
    ...
    fn bindgen_test_layout_rte_mempool_ops() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_mempool_ops ) ) . name as * const
                    _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_mempool_ops ) ,
                    "::" , stringify ! ( name ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_mempool_ops ) ) . alloc as *
                    const _ as usize } , 32usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_mempool_ops ) ,
                    "::" , stringify ! ( alloc ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_mempool_ops ) ) . free as * const
                    _ as usize } , 40usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_mempool_ops ) ,
                    "::" , stringify ! ( free ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_mempool_ops ) ) . enqueue as *
                    const _ as usize } , 48usize , concat ! (
                    "Alignment of field: " , stringify ! ( rte_mempool_ops ) ,
                    "::" , stringify ! ( enqueue ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_mempool_ops ) ) . dequeue as *
 ...
 */
    ...
    fn bindgen_test_layout_rte_spinlock_t() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_spinlock_t ) ) . locked as *
 ...
 */
    ...
    fn bindgen_test_layout_rte_mempool_ops_table() {
        assert_eq!(::std::mem::size_of::<rte_mempool_ops_table>() , 2112usize
                   , concat ! (
                   "Size of: " , stringify ! ( rte_mempool_ops_table ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_mempool_ops_table ) ) . sl as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_mempool_ops_table ) , "::" , stringify ! ( sl ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_mempool_ops_table ) ) . num_ops
                    as * const _ as usize } , 4usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_mempool_ops_table ) , "::" , stringify ! ( num_ops )
                    ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const rte_mempool_ops_table ) ) . ops as *
                    const _ as usize } , 64usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    rte_mempool_ops_table ) , "::" , stringify ! ( ops ) ));
    }
 ...
 */
    ...
    fn bindgen_test_layout_malloc_heap__bindgen_ty_1() {
        ...
        assert_eq! (::std::mem::align_of::<malloc_heap__bindgen_ty_1>() ,
                    8usize , concat ! (
                    "Alignment of " , stringify ! ( malloc_heap__bindgen_ty_1
                    ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const malloc_heap__bindgen_ty_1 ) ) .
                    lh_first as * const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    malloc_heap__bindgen_ty_1 ) , "::" , stringify ! (
                    lh_first ) ));
    }
    ...
    fn bindgen_test_layout_malloc_heap() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const malloc_heap ) ) . lock as * const _
                    as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( malloc_heap ) ,
                    "::" , stringify ! ( lock ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const malloc_heap ) ) . free_head as *
                    const _ as usize } , 8usize , concat ! (
                    "Alignment of field: " , stringify ! ( malloc_heap ) ,
                    "::" , stringify ! ( free_head ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const malloc_heap ) ) . alloc_count as *
                    const _ as usize } , 112usize , concat ! (
                    "Alignment of field: " , stringify ! ( malloc_heap ) ,
                    "::" , stringify ! ( alloc_count ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const malloc_heap ) ) . total_size as *
