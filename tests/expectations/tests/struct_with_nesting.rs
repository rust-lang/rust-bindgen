...
pub mod root {
    ...
    fn bindgen_test_layout_foo__bindgen_ty_1__bindgen_ty_1() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const foo__bindgen_ty_1__bindgen_ty_1 ) ) .
                    c1 as * const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    foo__bindgen_ty_1__bindgen_ty_1 ) , "::" , stringify ! (
                    c1 ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const foo__bindgen_ty_1__bindgen_ty_1 ) ) .
                    c2 as * const _ as usize } , 2usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    foo__bindgen_ty_1__bindgen_ty_1 ) , "::" , stringify ! (
                    c2 ) ));
    }
    ...
    fn bindgen_test_layout_foo__bindgen_ty_1__bindgen_ty_2() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const foo__bindgen_ty_1__bindgen_ty_2 ) ) .
                    d1 as * const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    foo__bindgen_ty_1__bindgen_ty_2 ) , "::" , stringify ! (
                    d1 ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const foo__bindgen_ty_1__bindgen_ty_2 ) ) .
                    d2 as * const _ as usize } , 1usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    foo__bindgen_ty_1__bindgen_ty_2 ) , "::" , stringify ! (
                    d2 ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const foo__bindgen_ty_1__bindgen_ty_2 ) ) .
                    d3 as * const _ as usize } , 2usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    foo__bindgen_ty_1__bindgen_ty_2 ) , "::" , stringify ! (
                    d3 ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const foo__bindgen_ty_1__bindgen_ty_2 ) ) .
                    d4 as * const _ as usize } , 3usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    foo__bindgen_ty_1__bindgen_ty_2 ) , "::" , stringify ! (
                    d4 ) ));
    }
