...
pub mod root {
    ...
    pub const JSVAL_PAYLOAD_MASK: ::std::os::raw::c_ulonglong =
        140737488355327;
    ...
    fn bindgen_test_layout_jsval_layout__bindgen_ty_2() {
        assert_eq!(::std::mem::size_of::<jsval_layout__bindgen_ty_2>() ,
                   4usize , concat ! (
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const jsval_layout__bindgen_ty_2 ) ) .
                    payload as * const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! (
                    jsval_layout__bindgen_ty_2 ) , "::" , stringify ! (
                    payload ) ));
    }
    ...
    fn bindgen_test_layout_jsval_layout() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const jsval_layout ) ) . asBits as * const
                    _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( jsval_layout ) ,
                    "::" , stringify ! ( asBits ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const jsval_layout ) ) . debugView as *
        ...
        assert_eq! (unsafe {
                    ...
                    "::" , stringify ! ( s ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const jsval_layout ) ) . asDouble as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( jsval_layout ) ,
                    "::" , stringify ! ( asDouble ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const jsval_layout ) ) . asPtr as * const _
                    as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( jsval_layout ) ,
                    "::" , stringify ! ( asPtr ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const jsval_layout ) ) . asWord as * const
                    _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( jsval_layout ) ,
                    "::" , stringify ! ( asWord ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const jsval_layout ) ) . asUIntPtr as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( jsval_layout ) ,
                    "::" , stringify ! ( asUIntPtr ) ));
    }
