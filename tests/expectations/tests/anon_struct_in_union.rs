...
pub mod root {
    ...
    fn bindgen_test_layout_s__bindgen_ty_1() {
        ...
        assert_eq! (::std::mem::align_of::<s__bindgen_ty_1>() , 4usize ,
                    concat ! (
                    "Alignment of " , stringify ! ( s__bindgen_ty_1 ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const s__bindgen_ty_1 ) ) . field as *
                    const _ as usize } , 0usize , concat ! (
    ...
    fn bindgen_test_layout_s() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const s ) ) . u as * const _ as usize } ,
                    0usize , concat ! (
                    "Alignment of field: " , stringify ! ( s ) , "::" ,
                    stringify ! ( u ) ));
    }
    impl Clone for s {
        fn clone(&self) -> Self { *self }
