...
pub mod root {
    ...
    fn bindgen_test_layout_A_B() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const A_B ) ) . member_b as * const _ as
                    usize } , 0usize , concat ! (
    ...
    fn bindgen_test_layout_A() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const A ) ) . member_a as * const _ as
                    usize } , 0usize , concat ! (
    ...
    #[test]
    fn __bindgen_test_layout_A_D_instantiation_17() {
        assert_eq!(::std::mem::size_of::<A_D<::std::os::raw::c_int>>() ,
                   4usize , concat ! (
                   "Size of template specialization: " , stringify ! (
                   A_D<::std::os::raw::c_int> ) ));
        assert_eq!(::std::mem::align_of::<A_D<::std::os::raw::c_int>>() ,
                   4usize , concat ! (
