 ...
 */
    ...
    fn bindgen_test_layout_cmdline_token_hdr() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const cmdline_token_hdr ) ) . ops as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( cmdline_token_hdr )
                    , "::" , stringify ! ( ops ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const cmdline_token_hdr ) ) . offset as *
 ...
 */
    ...
    fn bindgen_test_layout_cmdline_token_ops() {
        assert_eq!(::std::mem::size_of::<cmdline_token_ops>() , 32usize ,
                   concat ! ( "Size of: " , stringify ! ( cmdline_token_ops )
                   ));
        assert_eq! (::std::mem::align_of::<cmdline_token_ops>() , 8usize ,
                    concat ! (
                    "Alignment of " , stringify ! ( cmdline_token_ops ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const cmdline_token_ops ) ) . parse as *
                    const _ as usize } , 0usize , concat ! (
                    "Alignment of field: " , stringify ! ( cmdline_token_ops )
                    , "::" , stringify ! ( parse ) ));
        assert_eq! (unsafe {
                    & ( * ( 0 as * const cmdline_token_ops ) ) .
    ...
    fn bindgen_test_layout_cmdline_token_num_data() {
        assert_eq!(::std::mem::size_of::<cmdline_token_num_data>() , 4usize ,
                   concat ! (
                   "Size of: " , stringify ! ( cmdline_token_num_data ) ));
        ...
        assert_eq! (unsafe {
                    ...
                    * const _ as usize } , 0usize , concat ! (
                    ...
                    cmdline_token_num_data ) , "::" , stringify ! ( type_ )
                    ));
    }
    ...
    fn bindgen_test_layout_cmdline_token_num() {
        ...
        assert_eq! (unsafe {
                    & ( * ( 0 as * const cmdline_token_num ) ) . hdr as *
                    const _ as usize } , 0usize , concat ! (
