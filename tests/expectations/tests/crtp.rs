...
pub mod root {
    ...
    #[test]
    fn __bindgen_test_layout_Base_instantiation_10() {
    ...
    #[test]
    fn __bindgen_test_layout_BaseWithDestructor_instantiation_13() {
        assert_eq!(::std::mem::size_of::<BaseWithDestructor>() , 1usize ,
                   concat ! (
                   "Size of template specialization: " , stringify ! (
                   BaseWithDestructor ) ));
        assert_eq!(::std::mem::align_of::<BaseWithDestructor>() , 1usize ,
                   concat ! (
                   "Alignment of template specialization: " , stringify ! (
                   BaseWithDestructor ) ));
    }
