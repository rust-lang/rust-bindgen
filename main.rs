...
use std::io::fs;
use syntax::ast;
use syntax::codemap::{DUMMY_SP, ExpnInfo, NameAndSpan, MacroBang};
use syntax::ext::base;
...
pub fn main() {
    ...
    match parse_args(bind_args.as_slice()) {
        ...
        ParseOk(options, out) => {
            ...
            // Create dummy session and extension ctx - this will be provided by the macro
            ...
            let (module, attrs) = gen::gen_mod(&mut ext_cx, options.abi.as_slice(), options.links.as_slice(), globals);
