...
struct Struct_CXVersion {
    Major: c_int,
    Minor: c_int,
    Subminor: c_int,
}
type CXVersion = Struct_CXVersion;
...
const CXTranslationUnit_IncludeBriefCommentsInCodeCompletion: c_uint = 128;
...
const CXCursor_GCCAsmStmt: c_uint = 215;
...
const CXCursor_MSAsmStmt: c_uint = 229;
...
struct Struct_CXPlatformAvailability {
    Platform: CXString,
...
type CXPlatformAvailability = Struct_CXPlatformAvailability;
...
type Enum_CXCommentKind = c_uint;
const CXComment_Null: c_uint = 0;
const CXComment_Text: c_uint = 1;
const CXComment_InlineCommand: c_uint = 2;
const CXComment_HTMLStartTag: c_uint = 3;
const CXComment_HTMLEndTag: c_uint = 4;
const CXComment_Paragraph: c_uint = 5;
const CXComment_BlockCommand: c_uint = 6;
const CXComment_ParamCommand: c_uint = 7;
const CXComment_TParamCommand: c_uint = 8;
const CXComment_VerbatimBlockCommand: c_uint = 9;
const CXComment_VerbatimBlockLine: c_uint = 10;
const CXComment_VerbatimLine: c_uint = 11;
const CXComment_FullComment: c_uint = 12;
type Enum_CXCommentInlineCommandRenderKind = c_uint;
const CXCommentInlineCommandRenderKind_Normal: c_uint = 0;
const CXCommentInlineCommandRenderKind_Bold: c_uint = 1;
const CXCommentInlineCommandRenderKind_Monospaced: c_uint = 2;
const CXCommentInlineCommandRenderKind_Emphasized: c_uint = 3;
type Enum_CXCommentParamPassDirection = c_uint;
const CXCommentParamPassDirection_In: c_uint = 0;
const CXCommentParamPassDirection_Out: c_uint = 1;
const CXCommentParamPassDirection_InOut: c_uint = 2;
...
const CXCodeComplete_IncludeBriefComments: c_uint = 4;
...
const CXIdxEntity_CXXInterface: c_uint = 26;
...
extern  {
    ...
    fn clang_getCursorPlatformAvailability(++cursor: CXCursor,
                                           ++always_deprecated: *c_int,
                                           ++deprecated_message: *CXString,
                                           ++always_unavailable: *c_int,
                                           ++unavailable_message: *CXString,
                                           ++availability:
                                               *CXPlatformAvailability,
                                           ++availability_size: c_int) ->
       c_int;
    fn clang_disposeCXPlatformAvailability(++availability:
                                               *CXPlatformAvailability);
    ...
    fn clang_Cursor_isDynamicCall(++C: CXCursor) -> c_int;
    fn clang_Cursor_getCommentRange(++C: CXCursor) -> CXSourceRange;
    fn clang_Cursor_getRawCommentText(++C: CXCursor) -> CXString;
    fn clang_Cursor_getBriefCommentText(++C: CXCursor) -> CXString;
    fn clang_Cursor_getParsedComment(++C: CXCursor) -> CXComment;
    fn clang_Comment_getKind(++Comment: CXComment) -> Enum_CXCommentKind;
    fn clang_Comment_getNumChildren(++Comment: CXComment) -> c_uint;
    fn clang_Comment_getChild(++Comment: CXComment, ++ChildIdx: c_uint) ->
       CXComment;
    fn clang_Comment_isWhitespace(++Comment: CXComment) -> c_uint;
    fn clang_InlineContentComment_hasTrailingNewline(++Comment: CXComment) ->
       c_uint;
    fn clang_TextComment_getText(++Comment: CXComment) -> CXString;
    fn clang_InlineCommandComment_getCommandName(++Comment: CXComment) ->
       CXString;
    fn clang_InlineCommandComment_getRenderKind(++Comment: CXComment) ->
       Enum_CXCommentInlineCommandRenderKind;
    fn clang_InlineCommandComment_getNumArgs(++Comment: CXComment) -> c_uint;
    fn clang_InlineCommandComment_getArgText(++Comment: CXComment,
                                             ++ArgIdx: c_uint) -> CXString;
    fn clang_HTMLTagComment_getTagName(++Comment: CXComment) -> CXString;
    fn clang_HTMLStartTagComment_isSelfClosing(++Comment: CXComment) ->
       c_uint;
    fn clang_HTMLStartTag_getNumAttrs(++Comment: CXComment) -> c_uint;
    fn clang_HTMLStartTag_getAttrName(++Comment: CXComment, ++AttrIdx: c_uint)
       -> CXString;
    fn clang_HTMLStartTag_getAttrValue(++Comment: CXComment,
                                       ++AttrIdx: c_uint) -> CXString;
    fn clang_BlockCommandComment_getCommandName(++Comment: CXComment) ->
       CXString;
    fn clang_BlockCommandComment_getNumArgs(++Comment: CXComment) -> c_uint;
    fn clang_BlockCommandComment_getArgText(++Comment: CXComment,
                                            ++ArgIdx: c_uint) -> CXString;
    fn clang_BlockCommandComment_getParagraph(++Comment: CXComment) ->
       CXComment;
    fn clang_ParamCommandComment_getParamName(++Comment: CXComment) ->
       CXString;
    fn clang_ParamCommandComment_isParamIndexValid(++Comment: CXComment) ->
       c_uint;
    fn clang_ParamCommandComment_getParamIndex(++Comment: CXComment) ->
       c_uint;
    fn clang_ParamCommandComment_isDirectionExplicit(++Comment: CXComment) ->
       c_uint;
    fn clang_ParamCommandComment_getDirection(++Comment: CXComment) ->
       Enum_CXCommentParamPassDirection;
    fn clang_TParamCommandComment_getParamName(++Comment: CXComment) ->
       CXString;
    fn clang_TParamCommandComment_isParamPositionValid(++Comment: CXComment)
       -> c_uint;
    fn clang_TParamCommandComment_getDepth(++Comment: CXComment) -> c_uint;
    fn clang_TParamCommandComment_getIndex(++Comment: CXComment,
                                           ++Depth: c_uint) -> c_uint;
    fn clang_VerbatimBlockLineComment_getText(++Comment: CXComment) ->
       CXString;
    fn clang_VerbatimLineComment_getText(++Comment: CXComment) -> CXString;
    fn clang_HTMLTagComment_getAsString(++Comment: CXComment) -> CXString;
    fn clang_FullComment_getAsHTML(++Comment: CXComment) -> CXString;
    fn clang_FullComment_getAsXML(++Comment: CXComment) -> CXString;
    ...
    fn clang_getCompletionBriefComment(++completion_string:
                                           CXCompletionString) -> CXString;
